...
import (
	"github.com/stefandanzl/cloudr/middleware"
	...
	"github.com/stefandanzl/cloudr/pkg/hashid"
	"github.com/stefandanzl/cloudr/pkg/util"
	wopi2 "github.com/stefandanzl/cloudr/pkg/wopi"
	"github.com/stefandanzl/cloudr/routers/controllers"
