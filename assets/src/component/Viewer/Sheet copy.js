...
export default function Sheet() {
  ...
  useEffect(() => {
    // Load luckysheet.umd.js script
    const scriptElement1 = document.createElement('script');
    scriptElement1.src = 'https://cdn.jsdelivr.net/npm/luckysheet/dist/luckysheet.umd.js';
    scriptElement1.type = 'text/javascript';
    scriptElement1.onload = () => {
      // Luckysheet.umd.js script has loaded, now load plugin.js script
      const scriptElement2 = document.createElement('script');
      scriptElement2.src = 'https://cdn.jsdelivr.net/npm/luckysheet/dist/plugins/js/plugin.js';
      scriptElement2.type = 'text/javascript';
      scriptElement2.onload = () => setScriptLoaded(true)
    //   {
    //     const luckysheet = window.luckysheet;
    //   luckysheet.create({
