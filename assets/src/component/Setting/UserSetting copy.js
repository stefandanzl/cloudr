...
class UserSettingCompoment extends Component {
    ...
    changeInterval = () => {
        ...
        API.patch("/user/setting/interval", {
        ...
        return (
            <div>
                <div className={classes.layout}>
                    ...
                    {/* const [pdfSettings, setPdfSettings] = useState({ autoSave: true,  changePrompt: true, saveButton: true, autoSaveInterval_S: 10, }) */}
                    ...
                    <Paper>
                        ...
                        <Divider />
                            ...
                            >
                                ...
                                <ListItemText primary={"Auto Save Interval"} />
                ...
                <Dialog open={this.state.intervalModal} onClose={this.handleClose}>
                    <DialogTitle>{"Auto Save Interval"}</DialogTitle>
                    <DialogContent>
                        <TextField
                            id="standard-name"
